...
define('ADMIN_NAV_DATE_TIME_FORMAT', '%Y %b %d %A %X'); // this is used for strftime()
////
...
define('TEXT_CHECK_ALL', 'すべてチェックする');
define('TEXT_UNCHECK_ALL', 'すべてチェックしない');
define('NONE', 'None');
...
define('IMAGE_RESET_PWD', 'パスワードリセット');
...
define('TEXT_VERSION_CHECK_BUTTON', 'zen-cartのアップデートをチェック');
define('TEXT_BUTTON_RESET_ACTIVITY_LOG', 'アクティビティログを見る');
