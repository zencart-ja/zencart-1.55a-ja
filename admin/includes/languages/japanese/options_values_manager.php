...
// Option Name/Value to Option Name for Category with Product defaults
  ...
  define('TEXT_INFO_OPTION_VALUE_COPY_OPTIONS_TO', '商品に現在登録されているオプション名と値を選択してください。もしくは選択されたカテゴリー内にある、希望するオプション名を持った商品を選択してください
  <br /><strong>例:</strong>オプション名追加:色のOption値:赤を全てに適用、オプション名:Size
  <br /><strong>例:</strong>オプション名追加:ProductIDが34のvalue値を持つ商品の色のoption値:緑
  <br /><strong>例:</strong>オプション名追加:ProductIDが34のvalue値を持つ商品の色のoption値:緑CategoryIDのサイズ:65'
        ');
