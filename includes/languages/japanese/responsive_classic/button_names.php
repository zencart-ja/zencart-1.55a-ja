...
define('BUTTON_ADD_TO_CART_ALT', 'カートに加える');
define('BUTTON_ADD_ADDRESS_ALT', '住所を追加');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','選択してカートに追加');
define('BUTTON_BACK_ALT', '戻る');
define('BUTTON_BUY_NOW_ALT', '購入する');
define('BUTTON_CANCEL_ALT', 'キャンセル');
define('BUTTON_CHANGE_ADDRESS_ALT', '住所を変更');
define('BUTTON_CHECKOUT_ALT', '注文手続きへ');
define('BUTTON_CONFIRM_SEND_ALT', '商品券を送る');
define('BUTTON_CONFIRM_ORDER_ALT', '注文を確認');
define('BUTTON_CONTINUE_ALT', '続ける');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'ショッピングを続ける');
define('BUTTON_DELETE_ALT', '削除');
define('BUTTON_DELETE_SMALL_ALT', '削除');
define('BUTTON_DOWNLOAD_ALT', 'ダウンロード');
define('BUTTON_EDIT_SMALL_ALT', '編集');
define('BUTTON_IN_CART_ALT', 'カートに入れる');
define('BUTTON_LOGIN_ALT', 'サインイン');
define('BUTTON_LOOKUP_ALT', '見る');
define('BUTTON_NEXT_ALT', '次へ');
define('BUTTON_PREVIOUS_ALT', '前へ');
define('BUTTON_REDEEM_ALT', '回復');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', '商品リストへ戻る');
define('BUTTON_REVIEWS_ALT', 'レビューページへ行く');
define('BUTTON_SEARCH_ALT', '検索');
define('BUTTON_SEND_ALT', '送信');
define('BUTTON_SEND_ANOTHER_ALT', '別の商品券を送る');
define('BUTTON_SEND_A_GIFT_CERT_ALT', '商品券を送る');
...
define('BUTTON_UNSUBSCRIBE', '登録解除');
define('BUTTON_UPDATE_ALT', '更新');
define('BUTTON_VIEW_SMALL_ALT', 'ビュー');
define('BUTTON_WRITE_REVIEW_ALT', 'レビューを書く');
define('BUTTON_READ_REVIEWS_ALT', 'レビューを読む');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'この商品詳細へ行く');
define('BUTTON_MORE_REVIEWS_ALT', '他のレビューを読む');
