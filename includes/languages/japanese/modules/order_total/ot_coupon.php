 ...
 */
  ...
  define('MODULE_ORDER_TOTAL_COUPON_REDEEM_INSTRUCTIONS', '<p>クーポンコードをお持ちの場合は、引換コードの横にあるフォームに入力してください。クーポンは合計に対して適用され、「続ける」をクリックした後にカートに反映されます。</p><p>※ご注文ごとにひとつのクーポンしかご利用いただけません。</p>');
