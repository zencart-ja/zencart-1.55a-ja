...
// authorization pending
  ...
  define('TEXT_AUTHORIZATION_PENDING_CHECKOUT', 'チェックアウトできません - 未決定の承認があります');
...
// misc
  define('COLON_SPACER', ':&nbsp;&nbsp;');
  define('PAYMENT_JAVASCRIPT_DISABLED', 'Javascriptが使用不可にされている為、チェックアウトを続行することができませんでした。続けるには使用可能にしなければなりません。');
...
// create account - login shared
  ...
  define('ERROR_TEXT_COUNTRY_DISABLED_PLEASE_CHANGE', 'すみませんが、"%s"に請求または配送先住所を受け入れません。続けるには、どうぞ、住所をアップデートしてください。');
